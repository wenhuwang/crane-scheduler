...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ApplicationResourceAwareArgs)(nil), (*config.ApplicationResourceAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_ApplicationResourceAwareArgs_To_config_ApplicationResourceAwareArgs(a.(*ApplicationResourceAwareArgs), b.(*config.ApplicationResourceAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ApplicationResourceAwareArgs)(nil), (*ApplicationResourceAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ApplicationResourceAwareArgs_To_v1beta2_ApplicationResourceAwareArgs(a.(*config.ApplicationResourceAwareArgs), b.(*ApplicationResourceAwareArgs), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1beta2_ApplicationResourceAwareArgs_To_config_ApplicationResourceAwareArgs(in *ApplicationResourceAwareArgs, out *config.ApplicationResourceAwareArgs, s conversion.Scope) error {
	out.PolicyConfigPath = in.PolicyConfigPath
	return nil
}

// Convert_v1beta2_ApplicationResourceAwareArgs_To_config_ApplicationResourceAwareArgs is an autogenerated conversion function.
func Convert_v1beta2_ApplicationResourceAwareArgs_To_config_ApplicationResourceAwareArgs(in *ApplicationResourceAwareArgs, out *config.ApplicationResourceAwareArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_ApplicationResourceAwareArgs_To_config_ApplicationResourceAwareArgs(in, out, s)
}

func autoConvert_config_ApplicationResourceAwareArgs_To_v1beta2_ApplicationResourceAwareArgs(in *config.ApplicationResourceAwareArgs, out *ApplicationResourceAwareArgs, s conversion.Scope) error {
	out.PolicyConfigPath = in.PolicyConfigPath
	return nil
}

// Convert_config_ApplicationResourceAwareArgs_To_v1beta2_ApplicationResourceAwareArgs is an autogenerated conversion function.
func Convert_config_ApplicationResourceAwareArgs_To_v1beta2_ApplicationResourceAwareArgs(in *config.ApplicationResourceAwareArgs, out *ApplicationResourceAwareArgs, s conversion.Scope) error {
	return autoConvert_config_ApplicationResourceAwareArgs_To_v1beta2_ApplicationResourceAwareArgs(in, out, s)
}